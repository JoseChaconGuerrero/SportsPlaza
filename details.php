          ...
          <?php if (isset($_SESSION["id"])) {?>  <li>
            ...
            <li>
              <a href="./servi/index.php" class="trimRight"><svg>
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#sesion"></use>
                </svg></a>
            </li>
            <?php
          } ?>
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="flex">
            <div class="section-1">
              <img src="./assets/img/rifa2.jpg" alt="" class="ae-1" />
            </div>
            <div class="fix-7-12 left toRight">
              <div class="date ae-1">
                <p><svg class="is " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                  ...
                  </svg> <b>31 Ago, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <p class="ae-1">
                <b class="bold">‼Premio mayor</b> un BT 50 año 4x4 2012 + 10 cajas de cerveza<b class="bold">‼</b>
              </p>
              <p class="ae-1 big-number">31 Agosto, 2024</p>
              <h3 class="ae-1 big">En curso</h3 class="big">
          ...
          <div class="flex">
            ...
            <div class="fix-7-12 left toRight">
              <div class="date ae-1">
                <p><svg class="is " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                  </svg> <b>24 Ago, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                  </svg><b>10:10PM</b></p>
              </div>
              <h1 class="ae-1 huge">
              ...
              <p class="ae-1">
                una MD Haojin Lechuza 200CC 2024<b class="bold">‼</b></p>
              <p class="ae-1 big-number">24 Agosto, 2024</p>
              <h3 class="ae-1 big">En curso</h3 class="big">
          ...
          <div class="flex">
            ...
            <div class="fix-7-12 left toRight">
              <div class="date ae-1">
                <p><svg class="is " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                  </svg> <b>11 Ago, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                  </svg><b>10:10PM</b></p>
              </div>
              <h1 class="ae-1 huge">
                3ro premio y 4to premio
              </h1>

              <p class="ae-1"><b class="bold">3er Premio</b>$600 💸</p>
              <p class="ae-1"><b class="bold">4to Premio</b>$400 💸</p>
              <p class="ae-1 big-number">11 Agosto, 2024</p>
              <h3 class="ae-1 big">En curso</h3 class="big">
