...
$q = "SELECT * FROM raffles WHERE id=27";
...
<div class="chat">
    ...
    <div class="sections desktop">
      <div class="left">
        <a href="#" title="Slides Framework">
          <img src="./assets/img/sports.png" class="small" alt="" />
        </a>
      </div>
      <div class="center">
        <ul class="menu uppercase">
          <li><a href="#">Inicio</a></li>
          <li><a href="#rifa">Gran rifa</a></li>
          <li><a href="#chat">Chat</a></li>
          <li><a href="#end">Rifas en juego</a></li>
          <li><a href="#timer">Cuenta regresiva</a></li>
      ...
      <div class="right">
        <ul class="menu trim">
          <li>
            <a href="https://www.facebook.com/p/SportsPlaza-Colon-100045551456365/?locale=es_LA&paipv=0&eav=Afb99p1nkOe7eyYfRRxTLSVVv-xJ3KMGhLrSmYnMiYevkNnix7Uj0n2g1Dgd2jBvdJQ&_rdr" target="_blank"><svg>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#facebook"></use>
              </svg></a>
          </li>
          <li>
            <a href="https://www.instagram.com/sportsplazapark" class="trimRight" target="_blank"><svg>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#instagram"></use>
              </svg></a>
          </li>
          <?php if (isset($_SESSION["id"])) {?>  <li>
              <a href="./servi/acciones/salir.php?id=<?php echo $_SESSION["id"]; ?>" class="trimRight"><svg>
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#close"></use>
                </svg></a>
            </li><?php }
            else{ ?>
            <li>
              <a href="./servi/index.php" class="trimRight"><svg>
  ...
  <nav class="sidebar" data-sidebar-id="1">
    ...
    <div class="content">
      ...
      <ul class="social opacity-8">
        <li>
          <a href="https://www.facebook.com/p/SportsPlaza-Colon-100045551456365/?locale=es_LA&paipv=0&eav=Afb99p1nkOe7eyYfRRxTLSVVv-xJ3KMGhLrSmYnMiYevkNnix7Uj0n2g1Dgd2jBvdJQ&_rdr"><svg class="is">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#facebook"></use>
            </svg></a>
        </li>
        <li>
          <a href="https://www.instagram.com/sportsplazapark"><svg class="is">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#instagram"></use>
            </svg></a>
        </li>
      </ul>
  ...
  <section class="slide fade-6 kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="fix-12-12">
            <div class="slidder ae-1">
              <div class="wrapper1">
                <i id="left" class="fa-solid fa-angle-right"> <svg class="im">
                ...
                <ul class="carousel1 ">
                  ...
                  <div class="card video">
                    <video src="./assets/video/Sportsplaza.mp4" controls></video>
                  </div>
                  <div class="card video">
                    <video src="./assets/video/Sportsplaza2.mp4" controls></video>
                  </div>
                  <div class="card video">
                    <video src="./assets/video/Sportsplaza3.mp4" controls></video>
                  </div>

                </ul>

                <i id="right" class="fa-solid fa-angle-right"> <svg class="im">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
                  </svg></i>
              </div>
            </div>
            <!-- 
              <p class="ae-3"><span class="opacity-8">Registrate</span></p>
              <form class="slides-form" action="#" autocomplete="off">
                ...
                <button type="submit" class="button blue gradient ae-7 fromCenter" name="button">
                  Iniciar
                </button>
              </form>
              -->
  ...
  <!-- Slide 2 (#15) -->
  <section class="slide fade-6 kenBurns fromLeft" id="rifa">
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="flex">
            <div class="section-1">
            <img src="./assets/raffle/<?=$data['image']?>" alt="" class="ae-3" />
          
            </div>
            <div class="fix-7-12 left toRight">
              <div class="date">
                <p><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                  </svg> <b>21 Dic, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <p class="ae-2"> <span class="opacity-8"><b class="bold">Navidades resuelta con Nosotros</b></span></p>
              <p class="ae-2"> <span class="opacity-8">Participa por los grandes premios y los premios especiales</span>
              </p>
              <p class="ae-2">
                <span class="opacity-8">y el motivo mas importante de la </span> GRAN RIFA NAVIDEÑA
              </p>
              <p class="ae-2">
                <span class="opacity-8">Son las <b class="bold"> 30 FAMILIAS</b> 👨‍👩‍👧‍👦 más necesitadas... Que se les estará <b class="bold">Obsequiando $500</b> 💸 a cada una de ellas 👨‍👩‍👧‍👦 para un total de 15.000$ a obsequiar</span>
              </p>
              <p class="ae-2">
                <span class="opacity-8"><b class="bold">Y TU QUE ESPERAS PARA COMPRAR TU NUMERO DE LA SUERTE 🔮🎇

                  </b></span>
              </p>
              <a class="button blue gradient crop ae-3" href="./user/granrifa.php">Verifica
                numeros disponibles</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Slide 3 (#14) -->
  <section class="slide fade-6 kenBurns fromRight" id="chat">
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="fix-12-12">
            <div class="fix-6-12 left toLeft">
              ...
              <p class="ae-2">
                <span class="opacity-8">Para obtener información detallada sobre la adquisicion de números y otros
                  aspectos relacionados con la rifa, por favor, consulte nuestro chat de atención al cliente.</span>
              </p>
              <div class="button-flex">
                <a class="button blue gradient crop ae-3 " href="./servi/index.php">Ir al chat</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Slide 4 (#89) -->
  <section class="slide fade-6 kenBurns" id="end">
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="fix-12-12">
            ...
            <div class="slidder ae-1">
              <div class="wrapper">
                ...
                <ul class="carousel">
                  <a href="./user/granrifa.php" class="card">
                    <img src="./assets/raffle/<?=$data['image']?>" alt="img" draggable="false">
                    <div class="card-content">
                      <h2 class="huge">Gran rifa</h2>
                      <div class="date">
                        <p><svg class="is dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                          </svg> <b>21 Dic, 2024</b><svg class="is dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                          </svg><b>10:00PM</b></p>
                      </div>
                    </div>
                  ...
                  <a href="./details.php" class="card">
                    <img src="./assets/img/rifa2.jpg" alt="img" draggable="false">
                    <div class="card-content">
                      <h2 class="huge">Gran rifa</h2>
                      <div class="date">
                        <p><svg class="is dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                          </svg> <b>31 Ago, 2024</b><svg class="is dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                          </svg><b>10:10PM</b></p>
                      </div>
                    </div>
  ...
  <!-- Slide 5 (#85) -->
  <section class="slide fade-6 kenBurns" id="timer">
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="fix-7-12">
            <h1 class="ae-1 huge">Cuenta regresiva</h1>
            <div class="number-container ae-1">
              <div>
                <p class="big-number" id="days">99</p>
                <h3 class="big">Dias</h3 class="big">
              </div>
              <div>
                <p class="big-number" id="hours">23</p>
                <h3 class="big">Horas</h3 class="big">
              </div>
              <div>
                <p class="big-number" id="mins">12</p>
                <h3 class="big">Minutos</h3 class="big">
              </div>
              <div>
                <p class="big-number" id="seconds">12</p>
                <h3 class="big">Segundos</h3 class="big">
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="slide fade-6 kenBurns" id="contact">
    <div class="content">
      <div class="container">
        <div class="wrap contact ">
          <div class="c">
            <h2 class="huge ae-1 margin-bottom-2">Contacto</h2>
            <div class="contact-info ae-1">
              <div class="ae-1">
                <h3 class="huge">Numero</h3>
                <p>+58 424-7774539</p>
              </div>
              <div>
                <h3 class="huge">Correo</h3>
                <p>sportsplazacolonca@gmail.com</p>
              </div>
              <div>
                <h3 class="huge">Whatsapp</h3>
                <a href="https://wa.me/584247774539" class="trimRight" target="_blank"><svg class="im">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#whatsapp"></use>
                  </svg></a>
              </div>
              <div>
                <h3 class="huge">Facebook</h3>
                <a href="https://www.facebook.com/p/SportsPlaza-Colon-100045551456365/?locale=es_LA&paipv=0&eav=Afb99p1nkOe7eyYfRRxTLSVVv-xJ3KMGhLrSmYnMiYevkNnix7Uj0n2g1Dgd2jBvdJQ&_rdr" class="trimRight im" target="_blank"><svg class="im">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#facebook"></use>
                  </svg></a>
              </div>

              <div>
                <h3 class="huge">Instagram</h3>
                <p>sportsplazapark</p>
                <div class="">
                  <a href="https://www.instagram.com/sportsplazapark" class="trimRight" target="_blank"><svg class="im">
                      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#instagram"></use>
                    </svg></a>
                </div>
              ...
              <div>
                <h3 class="huge">Instagram</h3>
                <div>
                  <p>rifasvilladediaz2024</p>
                  <a href="https://www.instagram.com/rifasvilladediaz2024?igsh=MW91bnA1a2s3a3ZieQ== " class="trimRight" target="_blank"><svg class="im">
                      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#instagram"></use>
                    </svg></a>
                </div>
              ...
              <div>
                <h3 class="huge">Tiktok</h3>
                <div>
                  <p>@sportsplazapark</p>
                  <a href="https://www.tiktok.com/@sportsplazapark?_t=8o9MaUmPIso&_r=1" class="trimRight" target="_blank"><svg class="im" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                      <path d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.6 162.6 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z" />
                    </svg></a>
                </div>
              </div>
              <div>
                ...
                <div>
                  <p>@rifasvilladediaz2024</p>
                  <a href="https://www.tiktok.com/@rifasvilladediaz2024?_t=8oBte8Lqrna&_r=1 " class="trimRight" target="_blank"><svg class="im" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                      <path d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.6 162.6 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z" />
                    </svg></a>
                </div>
              </div>
          ...
          <div class="c">
            <h2 class="huge ae-1 margin-bottom-2">Metodos de pago</h3>
              <div class="payment row ae-1">
                <div class="col-md-3">
                  <h3 class="huge">Banco de Venezuela</h3>
                  <img src="./assets/img/pago1.png" alt="" srcset="">
                </div>
                <div class="col-md-3">
                  <h3 class="huge">Bancolombia</h3>
                  <img src="./assets/img/pago2.png" alt="" srcset="">
                </div>
                <div class="col-md-3">
                  <h3 class="huge">Neki</h3>
                  <img src="./assets/img/pago3.png" alt="" srcset="">
                </div>
                <div class="col-md-3">
                  <h3 class="huge">Zelle</h3>
                  <img src="./assets/img/pago4.png" alt="" srcset="">
                </div>
              </div>
          </div>
        </div>
    ...
    <div class="background" style="background-image: url(assets/img/background/img-95.jpg); background-position: top;">
    </div>
  </section>
  <!-- Panel Bottom #15 -->
  <nav class="panel bottom lastSlideOnly">
    <div class="sections">
      <div class="center">
        <p>Derechos @SPORTSPLAZA 2024. Copyright ©</p>
      </div>
    </div>
  </nav>
