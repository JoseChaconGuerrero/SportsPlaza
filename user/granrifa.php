...
<head>
  ...
  <link href="../css/table_numbers.css" rel="stylesheet" type="text/css" />
...
<body class="slides chain simplifiedMobile animated">
  ...
  <nav class="sidebar" data-sidebar-id="1">
    ...
    <div class="content">
      ...
      <ul class="mainMenu margin-top-3">
        ...
        <li><a href="#rifa">Rifas disponibles</a></li>
        <li><a href="#chat">Chat</a></li>
        <li><a href="#end">Rifas finalizadas</a></li>
  ...
  <!-- Slide 3 (#15) -->
  <section class="slide fade-6 kenBurns" id="numbers">
    <div class="content">
      <div class="container">
        <div class="wrap  ae-3">
          <div>
            ...
            <div class="row">
              <div class="col-12 numbers-container">
                ...
                <form id="formulario" action="../acciones/numbers.php" method="POST">
                  ...
                  ?>
                    <button type="submit" class="button button-submit blue gradient crop ae-3" id="number">Enviar</button>
                  <?php
                  } else {
                  ?>
                    <div class="button-flex">
                      <a class="button blue gradient crop ae-3 " href="../servi/index.php">Inicia sesion</a>
                    </div>
                  <?php
                  }
                  ?>
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="flex">
            <div class="section-1">
              <img src="../assets/raffle/<?=$data['image']?>" alt="" class="ae-1" />
            </div>
            <div class="fix-7-12 left toRight">
              <div class="date ae-1">
                <p><svg class="is " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                  ...
                  </svg> <b>21 Diciembre, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <p class="ae-1">
                <b class="bold">‼Premio mayor</b> un camión Hyundai HD72 año 2013<b class="bold">‼</b>
              </p>
              <p class="ae-1">
                <b class="bold">‼Segundo Premio</b> 5000$ 💸 en efectivo<b class="bold">‼</b>
              </p>
              <p class="ae-1"><b class="bold">‼ Tercer Premio</b> Una MOTO SBR 2024 🏍 <b class="bold">‼</b></p>
              <p class="ae-1"><b class="bold">‼Cuarto Premio</b> Una MOTO SBR 2024 🏍 <b class="bold">‼</b></p>
              <p class="ae-1"><b class="bold">‼Quinto Premio</b> Una MOTO SBR 2024 🏍 <b class="bold">‼</b></p>
          ...
          <div class="flex">
            ...
            <div class="fix-7-12 left toRight">
              <div class="date ae-1">
                <p><svg class="is " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                  </svg> <b>06 Julio, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                  </svg><b>10:00PM</b></p>
              </div>
              <h1 class="ae-1 huge">
              ...
              <p class="ae-2">
                <span class="opacity-8">PREMIO ESPECIAL POR 100$ 💸
                </span>
              </p>
              <p class="ae-1 big-number">06 Julio, 2024</p>
              <h3 class="ae-1 big">Finalizado</h3 class="big">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="flex">
            ...
            <div class="fix-7-12 left toRight">
              <div class="date">
                <p><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z" />
                  </svg> <b>03 Agosto, 2024</b><svg class="is" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                  </svg><b>10:00PM</b></p>
              </div>
              <h1 class="ae-1 huge">
              ...
              <div class="number-container">
                <div>
                  <p class="ae-1 big-number" id="days">99</p>
                  <h3 class="ae-1 big">Dias</h3 class="big">
                </div>
                <div>
                  <p class="ae-1 big-number" id="hours">23</p>
                  <h3 class="ae-1 big">Horas</h3 class="big">
                </div>
                <div>
                  <p class="ae-1 big-number" id="mins">12</p>
                  <h3 class="ae-1 big">Minutos</h3 class="big">
                </div>
                <div>
                  <p class="ae-1 big-number" id="seconds">12</p>
                  <h3 class="ae-1 big">Segundos</h3 class="big">
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="../js/timerTwo.js"></script>
